...
import { resolveLibraryTheme, type LibraryTheme } from './LibraryThemeSync'
...
export function FloatingHeader({
  ...
  const libraryVariant: LibraryTheme = resolveLibraryTheme(pathname, isInternal)

  // Claude is the only light-background header; Convert + Sidekick both have dark headers
  const headerOnDark = libraryVariant !== 'claude'
              ...
              <div className="justify-self-center">
                <Link href="/" className="inline-flex items-center justify-center">
                  {!convertLogoFailed ? (
                    <img
                      src={headerOnDark
                        ? '/logos/Convert_Logo_White.svg'
                        : '/logos/Convert_Logo_Dark Green.svg'}
                      alt="Convert"
